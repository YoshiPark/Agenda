...
class AgendaService {
   public:
    ...
    bool updateEmail(std::string username, std::string email);

    bool updatePassword(std::string username, std::string newpsd);

    bool updatePhone(std::string username, std::string phone);
